// LZMA SDK v26.00 -- decode only subset
// Original source: https://7-zip.org/sdk.html
// Files included: LzmaDecoder.cs, LzmaBase.cs, LzOutWindow.cs,
//   RangeCoder.cs (Decoder only), RangeCoderBit.cs (BitDecoder only),
//   RangeCoderBitTree.cs (BitTreeDecoder only), ICoder.cs (exceptions only)
// Encoder stuff and unused interfaces have been removed
...
namespace ArcViewer.LZMA
{
    ...
    // === RangeCoderBit.cs (BitDecoder only) ===
    ...
    // === RangeCoderBitTree.cs (BitTreeDecoder only) ===
